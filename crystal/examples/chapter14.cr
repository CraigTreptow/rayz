...
traffic_cone.transform = Rayz::Transformations.translation(-2.5, 0.0, 0.5)

cone_body = Rayz::Cone.new
cone_body.minimum = -1.0
cone_body.maximum = 0.0
cone_body.closed = true
cone_body.transform = Rayz::Transformations.scaling(0.4, 1.0, 0.4)
...
cone_base.minimum = -0.15
cone_base.maximum = 0.0
...
glass_cone.minimum = -1.0
glass_cone.maximum = 0.0
glass_cone.closed = true
glass_cone.transform =
  Rayz::Transformations.translation(0.0, 1.0, 0.5) *
...
metal_cone.minimum = -1.0
metal_cone.maximum = 0.0
metal_cone.closed = false
metal_cone.transform =
  Rayz::Transformations.translation(2.0, 1.5, 0.0) *
    Rayz::Transformations.rotation_x(Math::PI) *
    Rayz::Transformations.scaling(0.5, 1.5, 0.5)
