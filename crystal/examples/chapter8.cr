...
middle.material.pattern = Rayz::GradientPattern.new(
  Rayz::Color.new(0.1, 1.0, 0.5),
  Rayz::Color.new(1.0, 0.1, 0.5)
)
middle.material.pattern.not_nil!.transform = Rayz::Transformations.rotation_y(Math::PI / 4.0)
...
right.material.pattern = Rayz::RingPattern.new(
  Rayz::Color.new(0.5, 1.0, 0.1),
  Rayz::Color.new(0.1, 0.5, 1.0)
)
...
left.material.pattern = Rayz::CheckersPattern.new(
  Rayz::Color.new(1.0, 0.8, 0.1),
  Rayz::Color.new(0.1, 0.2, 0.8)
)
...
print "Rendering scene with patterns..."
image = camera.render(world)
puts "done"

file_name = "examples/chapter8.ppm"
