defmodule Rayz.TupleTest do
  ...
  describe "Rayz.Tuple.cross_product/2" do
  ...
  describe "Rayz.Tuple.dot_product/2" do
  ...
  describe "Rayz.Tuple.point?/1" do
  ...
  describe "Rayz.Tuple.vector?/1" do
  ...
  describe "Rayz.Tuple.new_point/3" do
  ...
  describe "Rayz.Tuple.new_vector/3" do
