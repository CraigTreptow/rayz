Given('a ← tuple\({float}, {float}, {float}, {float})') do |float, float2, float3, float4|
  @a = Rayz::Tuple.new(x: float, y: float2, z: float3, w: float4)
end

Given('b ← tuple\({float}, {float}, {float}, {float})') do |float, float2, float3, float4|
  @b = Rayz::Tuple.new(x: float, y: float2, z: float3, w: float4)
end
...
Given('p ← point\({float}, {float}, {float})') do |float, float2, float3|
  @p = Rayz::Point.new(x: float, y: float2, z: float3)
end
...
Given('v ← vector\({float}, {float}, {float})') do |float, float2, float3|
  @v = Rayz::Vector.new(x: float, y: float2, z: float3)
end
...
Given('a1 ← tuple\({float}, {float}, {float}, {float})') do |float, float2, float3, float4|
  @a1 = Rayz::Tuple.new(x: float, y: float2, z: float3, w: float4)
end

Given('a2 ← tuple\({float}, {float}, {float}, {float})') do |float, float2, float3, float4|
  @a2 = Rayz::Tuple.new(x: float, y: float2, z: float3, w: float4)
end
...
Given('zero ← vector\({float}, {float}, {float})') do |float, float2, float3|
  @zero = Rayz::Vector.new(x: float, y: float2, z: float3)
end
...
Then('a * {float} = tuple\({float}, {float}, {float}, {float})') do |float, float1, float2, float3, float4|
  expected = Rayz::Tuple.new(x: float1, y: float2, z: float3, w: float4)
...
Then('normalize\(v) = vector\({float}, {float}, {float})') do |float, float1, float2|
  expected = Rayz::Vector.new(x: float, y: float1, z: float2)
