Given('c ← color\({float}, {float}, {float})') do |float, float2, float3|
  @c = Rayz::Lib::Color.new(red: float, green: float2, blue: float3)
end
...
Given('color1 ← color\({float}, {float}, {float})') do |float, float2, float3|
  @color1 = Rayz::Lib::Color.new(red: float, green: float2, blue: float3)
end

Given('color2 ← color\({float}, {float}, {float})') do |float, float2, float3|
  @color2 = Rayz::Lib::Color.new(red: float, green: float2, blue: float3)
end

Given('color3 ← color\({float}, {float}, {float})') do |float, float2, float3|
  @color3 = Rayz::Lib::Color.new(red: float, green: float2, blue: float3)
end

Given('c1 ← color\({float}, {float}, {float})') do |float, float2, float3|
  @c1 = Rayz::Lib::Color.new(red: float, green: float2, blue: float3)
end

Given('c2 ← color\({float}, {float}, {float})') do |float, float2, float3|
  @c2 = Rayz::Lib::Color.new(red: float, green: float2, blue: float3)
end

Then('c1 + c2 = color\({float}, {float}, {float})') do |float, float2, float3|
  expected = Rayz::Lib::Color.new(red: float, green: float2, blue: float3)
...
Then('c * {float} = color\({float}, {float}, {float})') do |float, float2, float3, float4|
  expected = Rayz::Lib::Color.new(red: float2, green: float3, blue: float4)
