    ...
    def ppm_body
      ...
      rows.each_with_index do |r, idx|
        ...
        (0..@width - 1).each do |c|
          ...
          clamped_red = (pixel.red * total_values).round.clamp(0, MAX_COLORS)
          clamped_green = (pixel.green * total_values).round.clamp(0, MAX_COLORS)
          clamped_blue = (pixel.blue * total_values).round.clamp(0, MAX_COLORS)
